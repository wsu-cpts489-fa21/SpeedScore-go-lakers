        ...
        return (
            <div id="live-round-form"
              ...
              <div id="live-round-form-center">
                    <u>Edit Strokes:</u>
                    <button type="button" className={ this.state.stroke <= 199 ? "btn btn-dark" : "btn btn-opacity btn-dark disabled"} onClick={this.addStrokes}>+</button>
                    <span>{this.state.stroke + " (Par)"}</span>
                    <button type="button" className={this.state.stroke >= 2 ? "btn btn-dark" : "btn btn-opacity btn-dark disabled"} onClick={this.subtractStrokes}>-</button>
                    <u>Edit Time:</u>
              ...
              <div id="live-round-form-bottom">
                <button type="button"  className="btn btn-success" onClick={this.saveChanges}>
                     Save Changes
                </button>
